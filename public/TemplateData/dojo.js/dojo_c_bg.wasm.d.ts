...
export const toriiclient_getTokenCollections: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => any;
...
export const closure932_externref_shim: (a: number, b: number, c: any) => void;
export const closure1100_externref_shim: (a: number, b: number, c: any, d: any) => void;
